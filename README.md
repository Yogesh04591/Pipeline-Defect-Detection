...
<p align="center">
  <img src="outputs/sample_defect_detection.png" alt="Sample Output" width="600"/>
</p>
...
- [1] Zuo, Zhonglin, et al. “Leak detection for natural gas gathering pipelines under multiple operating conditions using RP-1dConvLSTM-AE and multimodel decision.” IEEE Transactions on Industrial Electronics (2023).
- [2] Gemeinhardt, Hayden, and Jyotsna Sharma. “Machine Learning-Assisted Leak Detection using Distributed Temperature and Acoustic Sensors.” IEEE Sensors Journal (2023).
- [3] Rajasekaran, Uma, and Mohanaprasad Kothandaraman. “A Novel Custom One-Dimensional Time-Series DenseNet for Water Pipeline Leak Detection and Localization Using Acousto-Optic Sensor.” IEEE Access (2024).
- [4] Zhao, Yuxin, et al. “Video detection of small leaks in buried gas pipelines.” IEEE Access (2023).
- [5] Islam, Mohammed Rezwanul, et al. “An Intelligent IoT and ML-Based Water Leakage Detection System.” IEEE Access (2023).
- [6] Chen, Suisheng, et al. “Leak detection in water supply network Using a data-driven improved graph convolutional network.” IEEE Access (2023).
- [7] Dashdondov, Khongorzul, Mi-Hye Kim, and Kyuri Jo. “NDAMA: A novel deep autoencoder and multivariate analysis approach for IOT-based methane gas leakage detection.” IEEE Access (2023).
- [8] Liu, Song, et al. “Analysis of the Propagation Characteristics of Acoustic Waves from Leakages in Buried Gas Pipelines.” IEEE Access (2023).
- [9] Tao, Tao, et al. “Intelligent Urban Sensing for Gas Leakage Risk Assessment.” IEEE Access 11 (2023): 37900-37910.
- [10] Casas, Edmundo, et al. “An End-to-End Platform for Managing Third-party Risks in Oil Pipelines.” IEEE Access (2024).
